...
const mockBorrowers: Borrower[] = [
  ...
  {
    id: '6',
    name: 'Meridian Office Partners',
    cipCode: 'MEROFF',
    relationshipId: '33-198765',
    noteNumber: '20230198-001',
    assetClass: 'CRE — Office',
    totalCreditExposure: 7400000,
    commitment: 7500000,
    totalDepositBalance: 620000,
    loanOfficer: 'Michael Torres',
    underwriter: 'Lisa Zhang',
  ...
  {
    id: '7',
    name: 'Mesa Data Solutions LLC',
    cipCode: 'MESADT',
    relationshipId: '44-112987',
    noteNumber: '20240112-001',
    assetClass: 'Data Center',
    totalCreditExposure: 11200000,
    commitment: 12000000,
  ...
  {
    id: '8',
    name: 'Desert Edge Colocation',
    cipCode: 'DESCOL',
    relationshipId: '28-287654',
    noteNumber: '20230287-001',
    assetClass: 'Data Center',
    totalCreditExposure: 8900000,
    commitment: 9000000,
    totalDepositBalance: 1100000,
    loanOfficer: 'Sarah Chen',
    underwriter: 'David Kim',
  ...
  {
    id: '9',
    name: 'Sunbelt Industrial REIT',
    cipCode: 'SUNIND',
    relationshipId: '55-163432',
    noteNumber: '20240163-001',
    assetClass: 'Industrial',
    totalCreditExposure: 14500000,
    commitment: 15000000,
    totalDepositBalance: 2200000,
    loanOfficer: 'David Park',
    underwriter: 'Rachel Martinez',
  ...
  {
    id: '10',
    name: 'Pinnacle Life Sciences',
    cipCode: 'PINLIF',
    relationshipId: '61-341876',
    noteNumber: '20230341-001',
    assetClass: 'CRE — Healthcare',
    totalCreditExposure: 9300000,
    commitment: 10000000,
    totalDepositBalance: 1450000,
    loanOfficer: 'Jennifer Wu',
    underwriter: 'James Thompson',
  ...
  {
    id: '11',
    name: 'Lakefront Mixed-Use LLC',
    cipCode: 'LAKMIX',
    relationshipId: '47-204513',
    noteNumber: '20240204-001',
    assetClass: 'CRE — Mixed-Use',
    totalCreditExposure: 6100000,
    commitment: 6500000,
    totalDepositBalance: 730000,
    loanOfficer: 'Michael Torres',
    underwriter: 'Lisa Zhang',
  ...
  },
  {
    ...
    cipCode: 'APXLOG',
    relationshipId: '39-419234',
    noteNumber: '20230419-001',
    assetClass: 'Industrial',
    totalCreditExposure: 10800000,
    commitment: 11000000,
...
export const borrowerDossiers: Record<string, BorrowerDossier> = {
  ...
  '6': {
    description: 'Meridian Office Partners owns and manages a portfolio of suburban office campuses leased to mid-market corporate tenants. The company focuses on value-add repositioning and long-term lease-up strategies.',
    dealDetails: [
      { label: 'Transaction Type',         value: 'Refinance' },
      { label: 'NAICS Code',               value: '531120' },
      { label: 'Property Type',            value: 'Suburban Office Campus' },
      { label: 'Facility Type',            value: 'Term Loan' },
      { label: 'Loan Term',                value: '48 months' },
      { label: 'Loan Maturity Date',       value: '6/30/2027' },
      { label: 'Interest Rate',            value: '6.10% Fixed' },
      { label: 'Amortization Structure',   value: 'Interest Only' },
      { label: 'LTV (As-Is)',              value: '71%' },
      { label: 'DSCR (Underwritten)',      value: '1.30x' },
    ...
    documents: [
      { name: 'Loan Agreement.pdf',               date: '07/22/2023' },
      { name: 'Financial Statements Q3 2025.pdf', date: '10/15/2025' },
      { name: 'Property Appraisal.pdf',           date: '06/30/2023' },
    ],
    kbDocuments: ['Axiom Commercial Lending Policy', 'CRE Underwriting Standards'],
  },
  '7': {
    description: 'Mesa Data Solutions LLC develops and operates wholesale colocation data centers serving hyperscale and enterprise clients in the Southwest. The company has a 98.9% uptime track record across its facilities.',
    dealDetails: [
      { label: 'Transaction Type',         value: 'New Origination' },
      { label: 'NAICS Code',               value: '518210' },
      { label: 'Facility Type',            value: 'Term Loan' },
      { label: 'Loan Term',                value: '48 months' },
      { label: 'Loan Maturity Date',       value: '3/31/2028' },
      { label: 'Interest Rate',            value: 'SOFR + 3750 bps' },
      { label: 'Amortization Structure',   value: 'I/O then 25-year amortization' },
      { label: 'Syndicated',               value: 'No' },
      { label: 'Revenue (Most Recent)',    value: '$18,200,000' },
      { label: 'EBITDA (Most Recent)',     value: '$7,100,000' },
      { label: 'Leverage Ratio',           value: '4.8x' },
      { label: 'Coverage Ratio (Actual)',  value: '1.58x' },
      { label: 'Primary Covenant Type',    value: 'Minimum DSCR' },
      { label: 'Primary Covenant Threshold', value: '1.25' },
      { label: 'Lien Position',            value: '1st' },
      { label: 'Critical Exception Present', value: 'No' },
      { label: 'Primary Repayment Source', value: 'Colocation Revenue' },
      { label: 'Underwriter Recommendation', value: 'Approve — Risk Rating 3 (Acceptable)' },
    ],
    documents: [
      { name: 'Credit Agreement.pdf',              date: '04/10/2024' },
      { name: 'Financial Statements Q4 2025.pdf',  date: '01/20/2026' },
      { name: 'Site Assessment.pdf',               date: '03/15/2024' },
    ],
    kbDocuments: ['Axiom Commercial Lending Policy', 'Data Center Asset Class Guidelines'],
  },
  '8': {
    description: 'Desert Edge Colocation operates multi-tenant colocation facilities in the Phoenix metro area. The company serves regional enterprise clients and government agencies and is in renewal discussions ahead of its November 2026 maturity.',
    dealDetails: [
      { label: 'Transaction Type',         value: 'Renewal' },
      { label: 'NAICS Code',               value: '518210' },
      { label: 'Facility Type',            value: 'Term Loan' },
      { label: 'Loan Term',                value: '36 months' },
      { label: 'Loan Maturity Date',       value: '11/30/2026' },
      { label: 'Interest Rate',            value: 'SOFR + 3250 bps' },
      { label: 'Revenue (Most Recent)',    value: '$11,400,000' },
      { label: 'EBITDA (Most Recent)',     value: '$4,200,000' },
      { label: 'Leverage Ratio',           value: '5.2x' },
      { label: 'Coverage Ratio (Actual)',  value: '1.37x' },
      { label: 'Primary Covenant Type',    value: 'Minimum DSCR' },
      { label: 'Primary Covenant Threshold', value: '1.20' },
      { label: 'Lien Position',            value: '1st' },
      { label: 'Critical Exception Present', value: 'Yes' },
      { label: 'Critical Exception Summary', value: 'Appraisal stale — refresh required prior to renewal closing' },
      { label: 'Primary Repayment Source', value: 'Colocation Revenue' },
      { label: 'Underwriter Recommendation', value: 'Approve with conditions — Risk Rating 3 (Acceptable)' },
    ],
    documents: [
      { name: 'Loan Agreement.pdf',               date: '09/05/2023' },
      { name: 'Financial Statements Q3 2025.pdf', date: '11/01/2025' },
      { name: 'Renewal Term Sheet.pdf',           date: '02/14/2026' },
    ],
    kbDocuments: ['Axiom Commercial Lending Policy', 'Data Center Asset Class Guidelines'],
  },
  '9': {
    description: 'Sunbelt Industrial REIT acquires and manages Class A logistics and distribution facilities across the Sun Belt corridor. The portfolio is anchored by investment-grade e-commerce and third-party logistics tenants.',
    dealDetails: [
      { label: 'Transaction Type',         value: 'Acquisition' },
      { label: 'NAICS Code',               value: '531130' },
      { label: 'Property Type',            value: 'Class A Logistics / Distribution' },
      { label: 'Facility Type',            value: 'Term Loan' },
      { label: 'Loan Term',                value: '60 months' },
      { label: 'Loan Maturity Date',       value: '1/15/2029' },
      { label: 'Interest Rate',            value: 'SOFR + 2500 bps' },
      { label: 'LTV (As-Is)',              value: '62%' },
      { label: 'DSCR (Underwritten)',      value: '1.67x' },
      { label: 'Occupancy Rate',           value: '100%' },
      { label: 'NOI (Most Recent)',        value: '$3,800,000' },
      { label: 'Primary Covenant Type',    value: 'Minimum DSCR' },
      { label: 'Primary Covenant Threshold', value: '1.25' },
      { label: 'Lien Position',            value: '1st' },
      { label: 'Critical Exception Present', value: 'No' },
    ...
    documents: [
      { name: 'Credit Agreement.pdf',              date: '06/01/2024' },
      { name: 'Financial Statements Q4 2025.pdf',  date: '01/25/2026' },
      { name: 'Property Appraisal.pdf',            date: '05/10/2024' },
      { name: 'Lease Abstracts.pdf',               date: '05/20/2024' },
    ],
    kbDocuments: ['Axiom Commercial Lending Policy', 'Industrial Asset Class Guidelines'],
  },
  '10': {
    description: 'Pinnacle Life Sciences develops and leases specialized laboratory and research facilities to biotech and pharmaceutical tenants. The company operates in the Research Triangle and Boston Seaport submarkets.',
    dealDetails: [
      { label: 'Transaction Type',         value: 'New Origination' },
      { label: 'NAICS Code',               value: '531190' },
      { label: 'Property Type',            value: 'Life Science / Lab Office' },
      { label: 'Facility Type',            value: 'Term Loan' },
      { label: 'Loan Term',                value: '48 months' },
      { label: 'Loan Maturity Date',       value: '10/31/2027' },
      { label: 'Interest Rate',            value: 'SOFR + 3000 bps' },
      { label: 'LTV (As-Is)',              value: '67%' },
      { label: 'DSCR (Underwritten)',      value: '1.44x' },
    ...
    documents: [
      { name: 'Loan Agreement.pdf',               date: '12/08/2023' },
      { name: 'Financial Statements Q3 2025.pdf', date: '10/20/2025' },
      { name: 'Lab Facility Appraisal.pdf',       date: '11/15/2023' },
    ],
    kbDocuments: ['Axiom Commercial Lending Policy', 'Healthcare Real Estate Asset Class Guidelines'],
  },
  '11': {
    description: 'Lakefront Mixed-Use LLC owns a mixed-use development in a high-traffic urban corridor combining ground-floor retail with Class B residential units. The company is seeking renewal ahead of its July 2026 maturity.',
    dealDetails: [
      { label: 'Transaction Type',         value: 'Renewal' },
      { label: 'NAICS Code',               value: '531110' },
      { label: 'Property Type',            value: 'Mixed-Use (Retail + Residential)' },
      { label: 'Facility Type',            value: 'Senior Loan' },
      { label: 'Loan Term',                value: '24 months' },
      { label: 'Loan Maturity Date',       value: '7/31/2026' },
      { label: 'Interest Rate',            value: '5.95% Fixed' },
      { label: 'LTV (As-Is)',              value: '74%' },
      { label: 'DSCR (Underwritten)',      value: '1.22x' },
    ...
    documents: [
      { name: 'Loan Agreement.pdf',               date: '07/19/2024' },
      { name: 'Financial Statements Q3 2025.pdf', date: '10/30/2025' },
      { name: 'Mixed-Use Appraisal.pdf',          date: '06/28/2024' },
    ],
    kbDocuments: ['Axiom Commercial Lending Policy', 'CRE Underwriting Standards'],
  },
  '12': {
    description: 'Apex Logistics Center is a single-tenant, build-to-suit distribution facility net leased to a national grocery chain. The property serves as a regional fulfillment hub and is structured as a long-term net lease.',
    dealDetails: [
      { label: 'Transaction Type',         value: 'Refinance' },
      { label: 'NAICS Code',               value: '531130' },
      { label: 'Property Type',            value: 'Single-Tenant Distribution / Fulfillment' },
      { label: 'Facility Type',            value: 'Term Loan' },
      { label: 'Loan Term',                value: '60 months' },
      { label: 'Loan Maturity Date',       value: '5/15/2028' },
      { label: 'Interest Rate',            value: 'SOFR + 2750 bps' },
      { label: 'LTV (As-Is)',              value: '60%' },
      { label: 'DSCR (Underwritten)',      value: '1.72x' },
      { label: 'Occupancy Rate',           value: '100%' },
      { label: 'NOI (Most Recent)',        value: '$2,950,000' },
      { label: 'Primary Covenant Type',    value: 'Minimum DSCR' },
      { label: 'Primary Covenant Threshold', value: '1.25' },
      { label: 'Lien Position',            value: '1st' },
      { label: 'Critical Exception Present', value: 'No' },
    ...
    documents: [
      { name: 'Credit Agreement.pdf',              date: '08/14/2023' },
      { name: 'Financial Statements Q4 2025.pdf',  date: '01/28/2026' },
      { name: 'Facility Appraisal.pdf',            date: '07/20/2023' },
      { name: 'Net Lease Agreement.pdf',           date: '08/01/2023' },
    ],
    kbDocuments: ['Axiom Commercial Lending Policy', 'Industrial Asset Class Guidelines'],
  },
};
